...
from state import inicializar_estado, actualizar_perfil_desde_mensaje
...
def procesar_turno(
    ...
    if user_message == None or user_message.strip() == "":
        respuesta_error("Mensaje vacío o nulo", ["Error: El mensaje no es valido"])
    
    # build_assistant_prompt(assistant_config, state, user_message)
    # safe_generate()
